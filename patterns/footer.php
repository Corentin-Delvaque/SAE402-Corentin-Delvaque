...
<h5 class="wp-block-heading" style="margin-top:40px;text-transform:none"><?php esc_html_e('Rejoindre la communauté', '');?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"40px"}}}} -->
<p style="margin-bottom:40px"><?php esc_html_e('Découvrir les nouveaux produits et les remises', '');?></p>
<!-- /wp:paragraph -->

<!-- wp:social-links {"size":"has-small-icon-size","className":"has-icon-color is-style-logos-only","style":{"spacing":{"blockGap":{"left":"16px"}}}} -->
<ul class="wp-block-social-links has-small-icon-size has-icon-color is-style-logos-only"><!-- wp:social-link {"url":"https://www.facebook.com","service":"facebook","className":"has-contrast-color"} /-->
...
<!-- wp:social-link {"url":"https://www.twitch.com","service":"twitch","className":"has-contrast-color"} /--></ul>
<!-- /wp:social-links --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:column {"verticalAlignment":"top","width":"20%","style":{"spacing":{"blockGap":"16px"}}} -->
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:20%"><!-- wp:navigation {"overlayMenu":"never","style":{"spacing":{"blockGap":"10px"}},"layout":{"overlayMenu":"never","type":"flex","orientation":"vertical"}} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<p class="has-text-align-center">
			Propulsé par <a href="https://wordpress.org" target="_blank" rel="noreferrer nofollow">WordPress</a> avec <a href="https://woocommerce.com" target="_blank" rel="noreferrer nofollow">WooCommerce</a>		</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->